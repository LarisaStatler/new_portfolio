...
function palindrom(word){
    ...
    for ( var i = 0;  i < len/2 ; i++ ){
        if (word[i] !== word[len-i]) { palindrom = false;}
    }
    return palindrom;
}
...
jQuery(document).ready(function ($) {
    console.log("ready");
    $(".hello_popup").show(500);
    $("body").on("click", ".hello_popup .action_close", function (e) {
        e.preventDefault();
        $(".hello_popup").hide(300);
    });
    //===== popup polindrom ====//

    $("body").on("click", ".open_polindrom", function (e) {
        e.preventDefault();
        $(".palindrom_popup").show(300);
    ...
    $("body").on("click", ".palindrom_popup .action_close", function (e) {
        e.preventDefault();
